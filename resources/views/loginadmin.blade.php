            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/signin2.png" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form action="{{ url('/checkloginadmin') }}" method="POST" class="register-form" id="login-form">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="status" id="email" placeholder="Admin"/>
                            </div>
                            <div class="form-group">
