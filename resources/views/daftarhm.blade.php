    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
        <div class="card-body p-0">
            <div class="p-4">
                ...
                <form class="form_addmagang" action="/simpan" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" placeholder="Nama Homestay" required>
                    </div>

                    <div class="form-group">
                        <input type="hidden" class="form-control" name="id" value="0">
                        <input type="text" class="form-control" name="alamat" placeholder="Alamat Homestay" required>
                    </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="fasilitas" placeholder="Fasilitas (AC,TV,dll)" required>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" name="tarif" placeholder="Harga (misal 500.000)" required>
                    </div>
                    ...
                    <div class="modal-footer">
                        <a  class="btn btn-secondary" id="cancel_btn" href="{{ url('sucessloginadmin') }}">Cancel</a>
